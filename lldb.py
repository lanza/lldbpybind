...
swig_version = (_to_int(0x040002 // 0x10000), _to_int(0x040002 // 0x100), _to_int(0x040002))
del _to_int
...
class SBBreakpoint(object):
    ...
    def SetThreadID(self, sb_thread_id: int):
...
def SBBreakpoint_GetBreakpointEventTypeFromEvent(event: "SBEvent") -> int:
...
class SBCommandInterpreter(object):
    ...
    def GetIOHandlerControlSequence(self, ch: str) -> str:
    ...
    def AllowExitCodeOnQuit(self, b: bool):
    ...
    def SourceInitFileInHomeDirectory(self, result: "SBCommandReturnObject"):
...
def SBCommandInterpreter_GetArgumentTypeAsCString(arg_type: int) -> str:
    r"""SBCommandInterpreter_GetArgumentTypeAsCString(lldb::CommandArgumentType const arg_type) -> char const *"""
    return _lldb.SBCommandInterpreter_GetArgumentTypeAsCString(arg_type)

def SBCommandInterpreter_GetArgumentDescriptionAsCString(arg_type: int) -> str:
...
class SBCommunication(object):
    ...
    def Read(self, dst: "void *", dst_len: int, timeout_usec: int, status: int) -> int:
    ...
    def Write(self, src: "void const *", src_len: int, status: int) -> int:
...
class SBData(object):
    ...
    def GetDescription(self, description: "SBStream", base_addr: int) -> bool:
    ...
    def ReadRawData(self, error: "SBError", offset: int, buf: "void *") -> int:
    ...
    def SetData(self, error: "SBError", buf: "void const *", endian: int, addr_size: int):
    ...
    @staticmethod
    def CreateDataFromUInt64Array(endian: int, addr_byte_size: int, array: "uint64_t *") -> 'SBData':
    ...
    @staticmethod
    def CreateDataFromUInt32Array(endian: int, addr_byte_size: int, array: "uint32_t *") -> 'SBData':
    ...
    @staticmethod
    def CreateDataFromSInt64Array(endian: int, addr_byte_size: int, array: "int64_t *") -> 'SBData':
    ...
    @staticmethod
    def CreateDataFromSInt32Array(endian: int, addr_byte_size: int, array: "int32_t *") -> 'SBData':
    ...
    @staticmethod
    def CreateDataFromDoubleArray(endian: int, addr_byte_size: int, array: "double *") -> 'SBData':
...
def SBData_CreateDataFromCString(endian: int, addr_byte_size: int, data: str) -> 'SBData':
    r"""SBData_CreateDataFromCString(lldb::ByteOrder endian, uint32_t addr_byte_size, char const * data) -> SBData"""
    return _lldb.SBData_CreateDataFromCString(endian, addr_byte_size, data)

def SBData_CreateDataFromUInt64Array(endian: int, addr_byte_size: int, array: "uint64_t *") -> 'SBData':
    r"""SBData_CreateDataFromUInt64Array(lldb::ByteOrder endian, uint32_t addr_byte_size, uint64_t * array) -> SBData"""
    return _lldb.SBData_CreateDataFromUInt64Array(endian, addr_byte_size, array)

def SBData_CreateDataFromUInt32Array(endian: int, addr_byte_size: int, array: "uint32_t *") -> 'SBData':
    r"""SBData_CreateDataFromUInt32Array(lldb::ByteOrder endian, uint32_t addr_byte_size, uint32_t * array) -> SBData"""
    return _lldb.SBData_CreateDataFromUInt32Array(endian, addr_byte_size, array)

def SBData_CreateDataFromSInt64Array(endian: int, addr_byte_size: int, array: "int64_t *") -> 'SBData':
    r"""SBData_CreateDataFromSInt64Array(lldb::ByteOrder endian, uint32_t addr_byte_size, int64_t * array) -> SBData"""
    return _lldb.SBData_CreateDataFromSInt64Array(endian, addr_byte_size, array)

def SBData_CreateDataFromSInt32Array(endian: int, addr_byte_size: int, array: "int32_t *") -> 'SBData':
    r"""SBData_CreateDataFromSInt32Array(lldb::ByteOrder endian, uint32_t addr_byte_size, int32_t * array) -> SBData"""
    return _lldb.SBData_CreateDataFromSInt32Array(endian, addr_byte_size, array)

def SBData_CreateDataFromDoubleArray(endian: int, addr_byte_size: int, array: "double *") -> 'SBData':
...
class SBDebugger(object):
    ...
    def EnableForwardEvents(self, listener: "SBListener"):
        r"""EnableForwardEvents(SBDebugger self, SBListener listener)"""
        return _lldb.SBDebugger_EnableForwardEvents(self, listener)
    ...
    def SetScriptLanguage(self, script_lang: int):
...
def SBDebugger_GetDefaultArchitecture(arch_name: str, arch_name_len: int) -> bool:
...
def SBDebugger_StateAsCString(state: int) -> str:
...
def SBDebugger_StateIsRunningState(state: int) -> bool:
    r"""SBDebugger_StateIsRunningState(lldb::StateType state) -> bool"""
    return _lldb.SBDebugger_StateIsRunningState(state)

def SBDebugger_StateIsStoppedState(state: int) -> bool:
...
class SBError(object):
    ...
    def SetErrorStringWithFormat(self, format: str, str1: str=None, str2: str=None, str3: str=None) -> "int":
...
class SBFile(object):
    ...
    @staticmethod
    def MakeBorrowed(BORROWED: 'SBFile') -> 'SBFile':
        r"""
    ...
    @staticmethod
    def MakeForcingIOMethods(FORCE_IO_METHODS: 'SBFile') -> 'SBFile':
        r"""
    ...
    @staticmethod
    def MakeBorrowedForcingIOMethods(BORROWED_FORCE_IO_METHODS: 'SBFile') -> 'SBFile':
        r"""
...
def SBFile_MakeBorrowed(BORROWED: 'SBFile') -> 'SBFile':
    r"""
...
def SBFile_MakeForcingIOMethods(FORCE_IO_METHODS: 'SBFile') -> 'SBFile':
    r"""
...
def SBFile_MakeBorrowedForcingIOMethods(BORROWED_FORCE_IO_METHODS: 'SBFile') -> 'SBFile':
    r"""
...
class SBFileSpec(object):
    ...
    def GetPath(self, dst_path: str, dst_len: int) -> int:
...
def SBFileSpec_ResolvePath(src_path: str, dst_path: str, dst_len: int) -> "int":
...
class SBHostOS(object):
    ...
    @staticmethod
    def ThreadCreate(name: str, arg2: "lldb::thread_func_t", thread_arg: "void *", err: "SBError") -> "lldb::thread_t":
...
def SBHostOS_GetLLDBPath(path_type: int) -> 'SBFileSpec':
...
def SBHostOS_ThreadCreate(name: str, arg2: "lldb::thread_func_t", thread_arg: "void *", err: "SBError") -> "lldb::thread_t":
...
class SBInstructionList(object):
    ...
    def GetInstructionsCount(self, start: "SBAddress", end: "SBAddress", canSetBreakpoint: bool) -> int:
...
def SBLanguageRuntime_GetLanguageTypeFromString(string: str) -> int:
    r"""SBLanguageRuntime_GetLanguageTypeFromString(char const * string) -> lldb::LanguageType"""
    return _lldb.SBLanguageRuntime_GetLanguageTypeFromString(string)

def SBLanguageRuntime_GetNameForLanguageType(language: int) -> str:
...
class SBListener(object):
    ...
    def StopListeningForEventClass(self, debugger: "SBDebugger", broadcaster_class: str, event_mask: int) -> int:
...
class SBModuleSpec(object):
    ...
    def SetUUIDBytes(self, uuid: "uint8_t const *", uuid_len: int) -> bool:
...
class SBPlatformShellCommand(object):
    ...
    def SetShell(self, shell_interpreter: str):
...
class SBPlatform(object):
    ...
    def SetWorkingDirectory(self, arg2: str) -> bool:
...
class SBProcess(object):
    ...
    def GetSTDOUT(self, dst: str) -> int:
        r"""
    ...
    def GetSTDERR(self, dst: str) -> int:
        r"""
    ...
    def ReadMemory(self, addr: int, buf: "void *", error: "SBError") -> int:
        r"""
    ...
    def WriteMemory(self, addr: int, buf: "void const *", error: "SBError") -> int:
        r"""
    ...
    def ReadCStringFromMemory(self, addr: int, char_buf: "void *", error: "SBError") -> int:
        r"""
    ...
    def LoadImage(self, image_spec: "SBFileSpec", error: "SBError") -> int:
    ...
    def SendEventData(self, event_data: str) -> 'SBError':
    ...
    def IsInstrumentationRuntimePresent(self, type: int) -> bool:
    ...
    def SaveCore(self, file_name: str) -> 'SBError':
        r"""SaveCore(SBProcess self, char const * file_name) -> SBError"""
        return _lldb.SBProcess_SaveCore(self, file_name)

    def StartTrace(self, options: "SBTraceOptions", error: "SBError") -> 'SBTrace':
...
def SBProcess_GetStateFromEvent(event: "SBEvent") -> int:
...
def SBProcess_GetNumRestartedReasonsFromEvent(event: "SBEvent") -> int:
    r"""SBProcess_GetNumRestartedReasonsFromEvent(SBEvent event) -> size_t"""
    return _lldb.SBProcess_GetNumRestartedReasonsFromEvent(event)

def SBProcess_GetRestartedReasonAtIndexFromEvent(event: "SBEvent", idx: int) -> str:
...
class SBQueueItem(object):
    ...
    def SetQueueItem(self, queue_item_sp: 'SBQueueItem'):
...
class SBSourceManager(object):
    ...
    def DisplaySourceLinesWithLineNumbers(self, file: "SBFileSpec", line: int, context_before: int, context_after: int, current_line_cstr: str, s: "SBStream") -> int:
    ...
    def DisplaySourceLinesWithLineNumbersAndColumn(self, file: "SBFileSpec", line: int, column: int, context_before: int, context_after: int, current_line_cstr: str, s: "SBStream") -> int:
...
class SBStream(object):
    ...
    def RedirectToFileHandle(self, file: 'SBFile', transfer_fh_ownership: bool):
...
class SBStructuredData(object):
    ...
    def GetStringValue(self, dst: str) -> int:
...
class SBTarget(object):
    ...
    def ReadMemory(self, addr: "SBAddress", buf: "void *", error: "SBError") -> int:
        r"""
...
def SBTarget_GetModuleAtIndexFromEvent(idx: int, event: "SBEvent") -> 'SBModule':
...
class SBThread(object):
    ...
    def GetStopDescription(self, dst_or_null: str) -> int:
        r"""
...
class SBThreadPlan(object):
    ...
    def QueueThreadPlanForStepOverRange(self, start_address: "SBAddress", range_size: int) -> 'SBThreadPlan':
    ...
    def QueueThreadPlanForStepInRange(self, start_address: "SBAddress", range_size: int) -> 'SBThreadPlan':
    ...
    def QueueThreadPlanForStepOut(self, frame_idx_to_step_to: int, first_insn: bool=False) -> 'SBThreadPlan':
...
class SBTrace(object):
    ...
    def GetTraceData(self, error: "SBError", buf: "void *", offset: int, thread_id: int) -> int:
    ...
    def GetMetaData(self, error: "SBError", buf: "void *", offset: int, thread_id: int) -> int:
...
class SBType(object):
    ...
    find_type.py:
            ...
            # SBType.GetBasicType() takes an enum int (lldb-enumerations.h).
...
class SBTypeCategory(object):
    ...
    def AddLanguage(self, language: int):
...
class SBVariablesOptions(object):
    ...
    def SetUseDynamic(self, arg2: int):
...
def SBWatchpoint_GetWatchpointEventTypeFromEvent(event: "SBEvent") -> int:
